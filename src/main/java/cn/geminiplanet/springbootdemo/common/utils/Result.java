package cn.geminiplanet.springbootdemo.common.utils;
...
/**
 * @author huangkexiang 2020-07-04
 */
public class Result {
    ...
    public static  JSONResultMap success(Object data, String message){
        return success(data).put(MESSAGE,message);
    }
    public static  JSONResultMap success(Object data, String message, int statusCode){
        return success(data,message).put("code",statusCode);
    }
    ...
    public static  JSONResultMap success(int statusCode){
        return success().put("code",statusCode);
    }
    ...
    public static  JSONResultMap fail(Object data, String message){
        return fail(data).put(MESSAGE,message);
    }
    public static  JSONResultMap fail(Object data, String message, int statusCode){
        return fail(data,message).put("code",statusCode);
    }
    ...
    public static  JSONResultMap fail(int statusCode){
        return fail().put("code",statusCode);
    }
    ...
    private static class JSONResultMap implements Map<String, Object> {
